...
//////////////////////////////////////////////////////////////////
// This section powers the 'open' and 'close' menu behaviours
  ...
  return (
    <>
      ...
      >
        ...
        <HamburgerIcon className="w-8 h-8 fill-current text-green-400" />
      </button>
      ...
      <div
        className={`${menuStyle} fixed top-0 left-0 h-full overflow-y-auto bg-white`}
        style={{
          width: width,
...
const HamburgerIcon = ({ ...props }) => {
  return (
    <svg viewBox="0 0 100 100" {...props}>
      <rect y="20" width="100" height="11"></rect>
      <rect y="50" width="100" height="11"></rect>
      <rect y="80" width="100" height="11"></rect>
    </svg>
  );
};
